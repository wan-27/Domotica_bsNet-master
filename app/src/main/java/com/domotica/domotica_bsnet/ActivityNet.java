...
public abstract class ActivityNet extends FragmentActivity {

    protected final static int   DEFAULT_CIDR = 24;
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if (action != null) {
                if (action.equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
                    ...
                    Log.i(TAG, "WifiState --> " + info_in_str);
                }
                ...
                if (action.equals(WifiManager.SUPPLICANT_STATE_CHANGED_ACTION) && net.getWifiInfo()) {
                    ...
                    Log.i(TAG, "SupplicantState --> " + info_in_str);
                }
            }
